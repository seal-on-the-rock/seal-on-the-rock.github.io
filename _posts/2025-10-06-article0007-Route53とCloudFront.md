...
|  比較項目　|  S3静的ファイル　|  APIレスポンス  |
|:-----------|:------------|:------------|
|内容の変化|ほぼ固定 |時々変化|
|キャッシュ戦略|長期間キャッシュ|TTLを短く設定·柔軟制御|
|主目的| ページ表示速度UP　| オリジン負荷軽減＆API速度向上|

S3は完全な静的キャッシュ、APIは「条件付きキャッシュ」と覚えるとわかりやすいです。
