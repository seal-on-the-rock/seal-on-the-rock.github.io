...
CloudWatch → OpenSearch → Athena → Okta Console

複数の画面を行き来する必要があり、調査効率が悪い のが現状です。

従来のログ分析の問題点
従来はログ用途ごとにツールが分かれていました。
![0012-6]( /assets/images/0012-06.png )
...
![0012-1]( /assets/images/0012-01.png )
...
![0012-2]( /assets/images/0012-02.png )
...
![0012-3]( /assets/images/0012-03.png )
...
![0012-4]( /assets/images/0012-04.png )
...
## 5. まとめ
全体を文字で整理すると次の通りです。
![0012-5]( /assets/images/0012-05.png )
